...
const products = [
  ...
  },
  {
    ...
    details: [
      "Material: Eco-friendly ceramics, bamboo, and recycled metal",
      "Dimensions: Varying sizes suitable for desks, shelves, and floor placement",
      "Finish: Matte, glossy, and textured options available",
      "Plant Compatibility: Works with real or faux plants",
      "Maintenance: Easy to clean and water-resistant designs",
    ],
    features: [
      "Versatile designs suitable for all interior styles",
      "Lightweight and durable for easy repositioning",
      "Easy to clean and maintain",
      "Water-resistant and non-toxic materials",
